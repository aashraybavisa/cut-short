...
let screenWidth = W_WIDTH;
let screenHeight = W_HEIGHT;
...
export const heightPx = (heightPercent: number) => {
  ...
  return (
    ((screenHeight - Number(getStatusBarHeight().toFixed(0))) * elemHeight) /
    100
  );
};
...
export const WINDOW_HEIGHT = W_HEIGHT;
export const WINDOW_WIDTH = W_WIDTH;
